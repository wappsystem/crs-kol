(function(){
    ...
    m[p+"notes-data"]       ={url:H+"/form-grid/backend/notes-data.html",Table:"crs-kol-notes",form_module:"notes-form",router:1},
    m[p+"notes-form"]       ={url:H+"/form-grid/backend/notes-form.html",Table:"crs-kol-notes"},
    ...
    m[p+"halsodeklaration-form"] ={url:H+"/form-grid/questionnaires/halsodeklaration-form.html",Table:"crs-kol-halsodeklaration",progress:'p7_1', task_name:"HÄLSODEKLARATION" };
